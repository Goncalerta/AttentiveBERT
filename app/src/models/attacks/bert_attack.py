def bert_attack(model_wrapper):
    """
    Fixed version (candidate size reduced) of BERT-Attack so that it takes less time to run:
    ============================================================
    ...
    # Candidate size K is set to 8 for all data-sets.
