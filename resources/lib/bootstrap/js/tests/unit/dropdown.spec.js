...
describe('Dropdown', () => {
    ...
    describe('constructor', () => {
        it('should take care of element either passed as a CSS selector or DOM element', () => {
            ...
            const dropdownBySelector = new Dropdown(
                '[data-bs-toggle="dropdown"]'
            );
    ...
    describe('toggle', () => {
        it('should toggle a dropdown', (done) => {
            ...
            btnDropdown.addEventListener('shown.bs.dropdown', () => {
                ...
                expect(btnDropdown.getAttribute('aria-expanded')).toEqual(
                    'true'
                );
                done();
            });
        ...
        it('should toggle a dropdown and add/remove event listener on mobile', (done) => {
            ...
            const defaultValueOnTouchStart =
            ...
            const dropdown = new Dropdown(btnDropdown, {
                ...
                popperConfig: {
                    onFirstUpdate() {
                        ...
                        expect(btnDropdown.classList.contains('show')).toEqual(
                            true
                        );
                        expect(
                            btnDropdown.getAttribute('aria-expanded')
                        ).toEqual('true');
                        done();
                    },
                },
    ...
    describe('data-api', () => {
        it('should show and hide a dropdown', (done) => {
            ...
            btnDropdown.addEventListener('shown.bs.dropdown', (event) =>
                setTimeout(() => {
                    expect(btnDropdown.classList.contains('show')).toEqual(
                        true
                    );
        ...
        it('should manage bs attribute `data-bs-popper`="none" when dropdown is in navbar', (done) => {
            ...
            btnDropdown.addEventListener('shown.bs.dropdown', () => {
                expect(dropdownMenu.getAttribute('data-bs-popper')).toEqual(
                    'none'
                );
                dropdown.hide();
            });
        ...
        it('should not use Popper if display set to static', (done) => {
            ...
            btnDropdown.addEventListener('shown.bs.dropdown', () => {
                ...
                expect(
                    dropdownMenu.getAttribute('data-popper-placement')
                ).toEqual(null);
                done();
            });
        ...
        it('should remove "show" class if body is clicked, with multiple dropdowns', (done) => {
            ...
            const [triggerDropdownFirst, triggerDropdownLast] =
                triggerDropdownList;
        ...
        it('should skip disabled element when using keyboard navigation', (done) => {
            ...
            triggerDropdown.addEventListener('shown.bs.dropdown', () => {
                ...
                ).toEqual(false, '.disabled not focused');
        ...
        it('should skip hidden element when using keyboard navigation', (done) => {
            ...
            triggerDropdown.addEventListener('shown.bs.dropdown', () => {
                ...
                expect(
                    document.activeElement.classList.contains('d-none')
                ).toEqual(false, '.d-none not focused');
        ...
        it('should propagate escape key events if dropdown is closed', (done) => {
            ...
            const toggle = fixtureEl.querySelector(
                '[data-bs-toggle="dropdown"]'
            );
        ...
        it('should close dropdown (only) by clicking inside the dropdown menu when it has data-attribute `data-bs-auto-close="inside"`', (done) => {
            ...
            const expectDropdownToBeOpened = () =>
                setTimeout(() => {
                    expect(dropdownToggle.classList.contains('show')).toEqual(
                        true
                    );
                    dropdownMenu.click();
                }, 150);
    ...
    it('should open dropdown when pressing keydown or keyup', (done) => {
        ...
        const handleArrowDown = () => {
            ...
            expect(triggerDropdown.getAttribute('aria-expanded')).toEqual(
                'true'
            );
            setTimeout(() => {
                dropdown.hide();
    ...
    it('should allow `data-bs-toggle="dropdown"` click events to bubble up', () => {
        ...
        const delegatedClickListener = jasmine.createSpy(
