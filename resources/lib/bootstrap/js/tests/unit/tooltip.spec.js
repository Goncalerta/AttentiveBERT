...
describe('Tooltip', () => {
    ...
    describe('show', () => {
        ...
        it('should show a tooltip relative to placement option', (done) => {
            ...
            tooltipEl.addEventListener('inserted.bs.tooltip', () => {
                expect(
                    tooltip
                        .getTipElement()
                        .classList.contains('bs-tooltip-bottom')
                ).toEqual(true);
            });
            ...
            tooltipEl.addEventListener('shown.bs.tooltip', () => {
                ...
                expect(
                    tooltipShown.classList.contains('bs-tooltip-bottom')
                ).toEqual(true);
                done();
            });
        ...
        it('should not hide tooltip if leave event occurs and enter event occurs within the hide delay', (done) => {
            ...
            setTimeout(() => {
                expect(
                    tooltip.getTipElement().classList.contains('show')
                ).toEqual(true);
        ...
        it('should use start class name when left placement specified', (done) => {
            ...
            tooltipEl.addEventListener('inserted.bs.tooltip', () => {
                expect(
                    tooltip
                        .getTipElement()
                        .classList.contains('bs-tooltip-start')
                ).toEqual(true);
                done();
            });
    ...
    describe('setElementContent', () => {
        ...
        it('should add html sanitized', () => {
            ...
            expect(tooltip.getTipElement().querySelector('button')).toEqual(
                null
            );
        });
    ...
    describe('aria-label', () => {
        it('should add the aria-label attribute for referencing original title', (done) => {
            ...
            tooltipEl.addEventListener('shown.bs.tooltip', () => {
                ...
                expect(tooltipShown).not.toBeNull();
                expect(tooltipEl.getAttribute('aria-label')).toEqual(
                    'Another tooltip'
                );
                done();
            });
