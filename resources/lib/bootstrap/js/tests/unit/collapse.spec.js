    ...
    describe('show', () => {
        ...
        it('should be able to handle toggling of other children siblings', (done) => {
            ...
            parentCollapseEl.addEventListener('shown.bs.collapse', () => {
                expect(parentCollapseEl.classList.contains('show')).toEqual(
                    true
                );
                childBtn1.click();
            });
            childCollapseEl1.addEventListener('shown.bs.collapse', () => {
                expect(childCollapseEl1.classList.contains('show')).toEqual(
                    true
                );
                childBtn2.click();
            });
            childCollapseEl2.addEventListener('shown.bs.collapse', () => {
                expect(childCollapseEl2.classList.contains('show')).toEqual(
                    true
                );
                expect(childCollapseEl1.classList.contains('show')).toEqual(
                    false
    ...
    describe('data-api', () => {
        it('should prevent url change if click on nested elements', (done) => {
            ...
            triggerEl.addEventListener('click', (event) => {
                ...
                expect(event.delegateTarget.isEqualNode(triggerEl)).toEqual(
                    true
                );
        ...
        it('should allow accordion to use children other than card', (done) => {
            ...
            collapseOne.addEventListener('shown.bs.collapse', () => {
                ...
                collapseTwo.addEventListener('shown.bs.collapse', () => {
                    expect(collapseOne.classList.contains('show')).toEqual(
                        false
                    );
                    expect(collapseTwo.classList.contains('show')).toEqual(
                        true
                    );
                    done();
                });
        ...
        it('should allow accordion to contain nested elements', (done) => {
            ...
            collapseOneEl.addEventListener('shown.bs.collapse', () => {
                ...
                expect(triggerEl.classList.contains('collapsed')).toEqual(
                    false
                );
                expect(triggerEl.getAttribute('aria-expanded')).toEqual('true');

                expect(collapseTwoEl.classList.contains('show')).toEqual(false);
                expect(triggerTwoEl.classList.contains('collapsed')).toEqual(
                    true
                );
                expect(triggerTwoEl.getAttribute('aria-expanded')).toEqual(
                    'false'
                );

                collapseTwoEl.addEventListener('shown.bs.collapse', () => {
                    expect(collapseOneEl.classList.contains('show')).toEqual(
                        false
                    );
                    expect(triggerEl.classList.contains('collapsed')).toEqual(
                        true
                    );
                    expect(triggerEl.getAttribute('aria-expanded')).toEqual(
                        'false'
                    );

                    expect(collapseTwoEl.classList.contains('show')).toEqual(
                        true
                    );
                    expect(
                        triggerTwoEl.classList.contains('collapsed')
                    ).toEqual(false);
                    expect(triggerTwoEl.getAttribute('aria-expanded')).toEqual(
                        'true'
                    );
        ...
        it('should allow accordion to target multiple elements', (done) => {
            ...
            function firstTest() {
                ...
                expect(collapseTwoTwo.classList.contains('show')).toEqual(
                    false
                );
            ...
            function secondTest() {
                ...
                expect(collapseOneTwo.classList.contains('show')).toEqual(
                    false
                );
        ...
        it('should collapse accordion children but not nested accordion children', (done) => {
            ...
            const collapseOne = fixtureEl.querySelector('#collapseOne');
            const collapseTwo = fixtureEl.querySelector('#collapseTwo');
            const nestedCollapseOne =
                fixtureEl.querySelector('#nestedCollapseOne');

            function handlerCollapseOne() {
                expect(collapseOne.classList.contains('show')).toEqual(true);
                expect(collapseTwo.classList.contains('show')).toEqual(false);
                expect(nestedCollapseOne.classList.contains('show')).toEqual(
                    false
                );
            ...
            function handlerNestedCollapseOne() {
                ...
                collapseTwo.addEventListener('shown.bs.collapse', () => {
                    ...
                    expect(
                        nestedCollapseOne.classList.contains('show')
                    ).toEqual(true);
                    done();
                });
        ...
        it('should add "collapsed" class and set aria-expanded to triggers only when all the targeted collapse are hidden', (done) => {
            ...
            const target2Shown = () => {
                ...
                target2.addEventListener('hidden.bs.collapse', () => {
                    expect(trigger1.classList.contains('collapsed')).toEqual(
                        false
                    );
                    expect(trigger1.getAttribute('aria-expanded')).toEqual(
                        'true'
                    );

                    expect(trigger2.classList.contains('collapsed')).toEqual(
                        true
                    );
                    expect(trigger2.getAttribute('aria-expanded')).toEqual(
                        'false'
                    );

                    expect(trigger3.classList.contains('collapsed')).toEqual(
                        false
                    );
                    expect(trigger3.getAttribute('aria-expanded')).toEqual(
                        'true'
                    );

                    target1.addEventListener('hidden.bs.collapse', () => {
                        expect(
                            trigger1.classList.contains('collapsed')
                        ).toEqual(true);
                        expect(trigger1.getAttribute('aria-expanded')).toEqual(
                            'false'
                        );
                        ...
                        expect(
                            trigger2.classList.contains('collapsed')
                        ).toEqual(true);
                        expect(trigger2.getAttribute('aria-expanded')).toEqual(
                            'false'
                        );
                        ...
                        expect(
                            trigger3.classList.contains('collapsed')
                        ).toEqual(true);
                        expect(trigger3.getAttribute('aria-expanded')).toEqual(
                            'false'
                        );
