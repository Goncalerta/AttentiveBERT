...
describe('ScrollBar', () => {
    ...
    const getOverFlowAttr = (el) =>
        Manipulator.getDataAttribute(el, 'overflow');
    ...
    const isScrollBarHidden = () => {
        ...
        return (
            calc.htmlClient === calc.htmlOffset &&
            calc.htmlClient === calc.window
        );
    };
    ...
    describe('hide - reset', () => {
        ...
        it("should not put data-attribute if element doesn't have the proper style property, should just remove style property if element didn't had one", () => {
            ...
            const hasPaddingAttr = (el) =>
                el.hasAttribute('data-bs-padding-right');
            const hasMarginAttr = (el) =>
                el.hasAttribute('data-bs-margin-right');
            ...
            expect(getPaddingX(stickyEl)).toEqual(
                scrollBarWidth + originalPadding
            );
