...
describe('Util', () => {
    ...
    describe('getElement', () => {
        it('should try to parse element', () => {
            ...
            expect(
                Util.getElement(fixtureEl.querySelectorAll('.test'))
            ).toBeNull();
    ...
    describe('findShadowRoot', () => {
        it('should return null if shadow dom is not available', () => {
            ...
            spyOn(document.documentElement, 'attachShadow').and.returnValue(
                null
            );
        ...
        it('should return the shadow root when found', () => {
            ...
            expect(Util.findShadowRoot(shadowRoot.firstChild)).toEqual(
                shadowRoot
            );
        });
    });
    ...
    describe('getNextActiveElement', () => {
        it('should return first element if active not exists or not given and shouldGetNext is either true, or false with cycling being disabled', () => {
            ...
            expect(Util.getNextActiveElement(array, '', true, true)).toEqual(
                'a'
            );
            expect(Util.getNextActiveElement(array, 'g', true, true)).toEqual(
                'a'
            );
            expect(Util.getNextActiveElement(array, '', true, false)).toEqual(
                'a'
            );
            expect(Util.getNextActiveElement(array, 'g', true, false)).toEqual(
                'a'
            );
            expect(Util.getNextActiveElement(array, '', false, false)).toEqual(
                'a'
            );
            expect(Util.getNextActiveElement(array, 'g', false, false)).toEqual(
                'a'
            );
        });
        ...
        it('should return last element if active not exists or not given and shouldGetNext is false but cycling is enabled', () => {
            ...
            expect(Util.getNextActiveElement(array, '', false, true)).toEqual(
                'd'
            );
            expect(Util.getNextActiveElement(array, 'g', false, true)).toEqual(
                'd'
            );
        });
        ...
        it('should return next element or same if is last', () => {
            ...
            expect(Util.getNextActiveElement(array, 'a', true, true)).toEqual(
                'b'
            );
            expect(Util.getNextActiveElement(array, 'b', true, true)).toEqual(
                'c'
            );
            expect(Util.getNextActiveElement(array, 'd', true, false)).toEqual(
                'd'
            );
        });
        ...
        it('should return next element or first, if is last and "isCycleAllowed = true"', () => {
            ...
            expect(Util.getNextActiveElement(array, 'c', true, true)).toEqual(
                'd'
            );
            expect(Util.getNextActiveElement(array, 'd', true, true)).toEqual(
                'a'
            );
        });
        ...
        it('should return previous element or same if is first', () => {
            ...
            expect(Util.getNextActiveElement(array, 'b', false, true)).toEqual(
                'a'
            );
            expect(Util.getNextActiveElement(array, 'd', false, true)).toEqual(
                'c'
            );
            expect(Util.getNextActiveElement(array, 'a', false, false)).toEqual(
                'a'
            );
        });
        ...
        it('should return next element or first, if is last and "isCycleAllowed = true"', () => {
            ...
            expect(Util.getNextActiveElement(array, 'a', false, true)).toEqual(
                'd'
            );
        });
    });
