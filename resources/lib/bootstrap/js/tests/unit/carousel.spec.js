    ...
    describe('next', () => {
        ...
        it('should fire slide event with: direction, relatedTarget, from and to', (done) => {
            ...
            const onSlide = (event) => {
                expect(event.direction).toEqual('left');
                expect(
                    event.relatedTarget.classList.contains('carousel-item')
                ).toEqual(true);
        ...
        it('should update indicators if present', (done) => {
            ...
            carouselEl.addEventListener('slid.bs.carousel', () => {
                expect(firstIndicator.classList.contains('active')).toEqual(
                    false
                );
                expect(firstIndicator.hasAttribute('aria-current')).toEqual(
                    false
                );
                expect(secondIndicator.classList.contains('active')).toEqual(
                    true
                );
                expect(secondIndicator.getAttribute('aria-current')).toEqual(
                    'true'
                );
                done();
            });
