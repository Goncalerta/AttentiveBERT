...
describe('ScrollSpy', () => {
    ...
    describe('constructor', () => {
        ...
        it('should not process element without target', () => {
            ...
            const scrollSpy = new ScrollSpy(
                fixtureEl.querySelector('#content'),
                {
                    target: '#navigation',
                }
            );
        ...
        it('should clear selection if above the first section', (done) => {
            ...
            contentEl.addEventListener('scroll', () => {
                ...
                if (firstTime) {
                    expect(
                        fixtureEl.querySelectorAll('.active').length
                    ).toEqual(1);
        ...
        it('should allow passed in option offset method: offset', () => {
            ...
            expect(scrollSpy._offsets[1]).toEqual(
    ...
    describe('jQueryInterface', () => {
        ...
        it('should create a scrollspy with given config', () => {
            ...
            expect(ScrollSpy.prototype.constructor).not.toHaveBeenCalledWith(
                div,
                { offset: 15 }
            );
    ...
    describe('getOrCreateInstance', () => {
        it('should return scrollspy instance', () => {
            ...
            expect(ScrollSpy.getOrCreateInstance(div)).toBeInstanceOf(
                ScrollSpy
            );
        });
